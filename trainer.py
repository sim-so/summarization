...
class MaximumLikelihoodEstimationEngine(Engine):
    ...
    def train(engine, mini_batch):
        ...
        # before to take another step in gradient.
        engine.model.train()
        ...
        if engine.state.iteration % engine.config.iteration_per_update == 0 and \
            ...
            # In oder to avoid gradient exploding, we apply gradient clipping.
...
class SingleTrainer():
    ...
    def train(
        ...
        # Do necesasry attach procedure to train & validation engine.
        ...
        # Attach validation loss check rocedure for every end of validation epoch.
        validation_engine.add_event_handler(
            Events.EPOCH_COMPLETED, self.target_engine_class.check_best
        )
        # Attach model save procedure for every end of vlidation epoch.
        validation_engine.add_event_handler(
            Events.EPOCH_COMPLETED,
