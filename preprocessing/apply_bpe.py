...
def create_parser():
    ...
    parser.add_argument(
        '--codes', '-c', type=argparse.FileType('r'), 
    ...
    parser.add_argument(
        ...
        metavar='PATH',
        help="Vocabulary file (built with get_vocab.py). If provided, this script reverts any merge operations that product an OOV."
    )
    parser.add_argument(
        '--vocabulary-threshold', type=int, default=None,
        metavar='INT',
        help="Vocabulary threshold. If vocabulary is provided, any word with frequency < threshod will be treated as OOV."
    )
    parser.add_argument(
        '--glossaries', type=str, nargs='+', default=None,
        metavar='STR',
        help="Glossaries. The string provided in glossaries will not be affected."+
              "by the BPE (i.e. The will neither be broken into subwords, nor conccatenated with other subwords."
    )
...
def encode(orig, bpe_codes, bpe_codes_reverse, vocab, separator, version, cache, glossaries=None):
    """Encode word based on list of BPE merge operations, which are applied consectively
    """
...
def read_vocabulary(vocab_file, threshold):
    """Read vocabulary file produced by get_vocab.py, andf ilter according to frequency threshold.
    """
...
if __name__ == '__main__':
    ...
    for line in args.input:
        ...
        if leading_whitespace:
            # args.output.write(line[:leadingwhitespace])
            pass
